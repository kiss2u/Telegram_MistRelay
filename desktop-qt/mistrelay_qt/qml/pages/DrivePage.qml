...
ResponsivePage {
    ...
    readonly property bool dualPane: contentFrameWidth >= 1080
    ...
    GridLayout {
        ...
        GlassCard {
            ...
            Layout.preferredWidth: root.dualPane ? root.contentFrameWidth - 408 : root.contentFrameWidth
            Layout.preferredHeight: root.dualPane ? 760 : 620
            ...
            ColumnLayout {
                ...
                ScrollView {
                    Layout.fillWidth: true
                    Layout.fillHeight: root.dualPane
                    Layout.preferredHeight: root.dualPane ? 680 : 520
                    clip: true
                            ...
                            delegate: Rectangle {
                                ...
                                GridLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        implicitWidth: root.compact ? parent.width : 96
                                        implicitHeight: 84
                                    ...
                                    Flow {
                                        Layout.fillWidth: true
                                        width: root.compact ? itemLayout.width : implicitWidth
                                        spacing: 8
        ...
        GlassCard {
            Layout.fillWidth: true
            Layout.alignment: Qt.AlignTop
            Layout.preferredWidth: root.dualPane ? 390 : root.contentFrameWidth
            Layout.preferredHeight: root.dualPane ? 760 : 460
            backgroundColor: "#ffffffff"
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: root.dualPane ? -1 : 260
                    radius: ThemeSystem.Theme.radiusLarge
                    color: "#0f172a"
                    border.width: 1
                    border.color: "#1e293b"
